              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  <p className="text-blue-100 text-lg leading-relaxed">
                    Founded in 2024, EmotionAI emerged from a simple yet powerful vision: to democratize artificial intelligence by making cutting-edge AI models accessible to everyone.
                  </p>
            ...
            description={
              <div className="space-y-8">
                ...
                <div className="text-center">
                  ...
                  <div className="mt-4 text-yellow-200 text-sm">— EmotionAI Team</div>
                </div>
